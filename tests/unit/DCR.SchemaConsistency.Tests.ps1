...
Describe 'DCR stream declarations — invariants' {
    ...
    It 'DCR declares exactly 67 streams (66 data + 1 system XdrConnectorHealth_CL)' {
        # v0.1.0 GA F1 (2026-05-08): MachineActions removed. 45 baseline + 13 Tier A + 6 Phase 1 (B+G7+G8) + 1 ops = 65
        # Phase 2 batch 1 (2026-05-09 R++++++++++): MDE_PendingActions_CL added (Action Center) - 65 -> 66
        # Phase 2 batch 2 (2026-05-09): MDE_IdentityDormantAccounts_CL added (Identity Protection MDI) - 66 -> 67
        $script:DcrStreamDecls.Count | Should -Be 67
    }
}
