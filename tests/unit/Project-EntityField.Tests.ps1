...
<#
.SYNOPSIS
    v0.1.0 GAA — typed-column projection helper gate. Asserts
...
.DESCRIPTION
    Locked invariants:
      ...
      ConvertTo-MDEIngestRow.WithoutProjectionMap
        — v0.1.0 GA scope (original 4-column shape) preserved.
...
Describe 'ConvertTo-MDEIngestRow — ProjectionMap application' {
    ...
    It 'omits ProjectionMap columns when no map supplied (v0.1.0 GA scope)' {
