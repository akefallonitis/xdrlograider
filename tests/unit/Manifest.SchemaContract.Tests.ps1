...
Describe 'Manifest counts (v0.1.0 GA)' {
    ...
    It 'manifest contains exactly 66 streams (45 baseline + 13 Tier A Phase 2 + 6 Phase 1 + 2 Phase 2 Tier A: PendingActions + IdentityDormantAccounts)' {
        ...
        $script:Manifest.Count | Should -Be 66
    }
    ...
    It 'live + tenant-gated + deprecated counts add up' {
        ...
        ($live + $tenantGated + $deprecated) | Should -Be 66
        $live | Should -Be 65 -Because 'R++ all-live policy + Phase 1 6 new streams + Phase 2 batches 1-2 (PendingActions + IdentityDormantAccounts): 66 total - 1 deprecated = 65 live'
