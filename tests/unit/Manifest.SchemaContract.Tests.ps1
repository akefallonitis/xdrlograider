...
Describe 'Manifest counts (v0.1.0 GA)' {
    ...
    It 'manifest contains exactly 68 streams (45 baseline + 13 Tier A Phase 2 + 6 Phase 1 + 4 Phase 2 Tier A: PendingActions + IdentityDormantAccounts + IdentityLateralMovementPaths + VulnerabilityCertificates)' {
        ...
        $script:Manifest.Count | Should -Be 68
    }
    ...
    It 'live + tenant-gated + deprecated counts add up' {
        ...
        ($live + $tenantGated + $deprecated) | Should -Be 68
        $live | Should -Be 67 -Because 'R++ all-live policy + Phase 1 6 new streams + Phase 2 batches 1-4: 68 total - 1 deprecated = 67 live'
