...
Describe 'Manifest counts (v0.1.0 GA)' {
    ...
    It 'manifest contains exactly 72 streams (45 baseline + 13 Tier A Phase 2 + 6 Phase 1 + 8 Phase 2 Tier A batches)' {
        ...
        $script:Manifest.Count | Should -Be 72
    }
    ...
    It 'live + tenant-gated + deprecated counts add up' {
        ...
        ($live + $tenantGated + $deprecated) | Should -Be 72
        $live | Should -Be 71 -Because 'R++ all-live policy + Phase 1 6 new streams + Phase 2 batches 1-8: 72 total - 1 deprecated = 71 live'
