...
Describe 'Manifest counts (v0.1.0 GA)' {
    ...
    It 'manifest contains exactly 69 streams (45 baseline + 13 Tier A Phase 2 + 6 Phase 1 + 5 Phase 2 Tier A batches)' {
        ...
        $script:Manifest.Count | Should -Be 69
    }
    ...
    It 'live + tenant-gated + deprecated counts add up' {
        ...
        ($live + $tenantGated + $deprecated) | Should -Be 69
        $live | Should -Be 68 -Because 'R++ all-live policy + Phase 1 6 new streams + Phase 2 batches 1-5: 69 total - 1 deprecated = 68 live'
