...
- **[XDRInternals](https://github.com/MSCloudInternals/XDRInternals)** (Fabian Bader & Nathan McNulty, MIT · ~124★) — the community module documenting programmatic Defender XDR portal access. Our in-tree auth **adapts the delegated sign-in patterns it establishes** (ESTS, passkey/FIDO2, TOTP, TAP), and we cross-validate pagination / time-filter / sub-portal conventions against it.
