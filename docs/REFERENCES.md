...
DCE ingestion URL format and auth. Our DCE is deployed via the hand-authored ARM template (`deploy/compiled/mainTemplate.json`); the Function App's managed identity authenticates to it.
