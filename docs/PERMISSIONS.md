...
| **Owner** *(or Log Analytics Contributor + Microsoft Sentinel Contributor)* | Workspace RG | Write 11 consolidated custom tables (10 Defender_<Category>_CL + 1 XdrConnectorHealth_CL), savedSearches (parsers + hunting queries), workbooks, and analytic rules via cross-RG nested deployments |
...
| **Log Analytics Contributor** | Workspace RG | Write 11 consolidated custom tables (10 Defender_<Category>_CL + 1 XdrConnectorHealth_CL) + savedSearches |
