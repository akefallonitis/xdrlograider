...
- `Microsoft Sentinel Contributor` covers Sentinel-specific resources: analytic rules (`Microsoft.SecurityInsights/alertRules/write`), data-connector UI cards (`Microsoft.SecurityInsights/dataConnectorDefinitions`), workbooks (`Microsoft.Insights/workbooks/write`).
