# poll-p2-governance-1d — daily poll of all Tier 2 governance/RBAC streams (6 endpoints, v1.0.2).
...
try {
    ...
    $result = Invoke-MDETierPoll -Session $session -Tier 'P2' -Config $config
