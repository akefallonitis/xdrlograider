# poll-p1-pipeline-30m — 30-min poll of all Tier 1 integration/pipeline streams (7 endpoints).
...
try {
    ...
    $result = Invoke-MDETierPoll -Session $session -Tier 'P1' -Config $config
